...
#tomogram="/net/micdata/data2/12IDC/2025_Jul/results/analysis_tomo/ZC6_3D/p39nm/tomogram_alignment_recon.tiff"
...
cellinfo_data = load_cellinfo_data("/net/micdata/data2/12IDC/2025_Jul/results/analysis_tomo/ZC6_3D/p39nm/cellinfo.mat")
...
plot_unit_cell_in_tomogram(tomogram_test, cellinfo_data, plot_tomogram=True, \
    intensity_threshold=0.4, pixel_size=20)
