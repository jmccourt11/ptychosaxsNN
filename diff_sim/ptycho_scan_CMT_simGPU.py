...
def load_and_prepare_data():
    ...
    base_directory = '/net/micdata/data2/12IDC/2025_Feb/ptychi_recons/'
    recon_path = 'Ndp1024_LSQML_c20_m0.5_gaussian_p10_cp_mm_opr1_ic_pc_ul2/'
    scan_number = 62
    ...
    with h5py.File(f"{base_directory}S{scan_number:04d}/{recon_path}/recon_Niter1000.h5", 'r') as f:
        ob = f['object'][()]
        pb = f['probe'][()]
    #ob = sio.loadmat(f"{base_directory}/results/{sample_dir}/fly{scan_number:03d}/roi0_Ndp256/{recon_path}/Niter1000.mat")
...
def main():
    ...
    with cp.cuda.Device(gpu_id):
        ...
        sim_size = 1024#1024  # Size for simulation (can be larger than dpsize)
        grid_size = sim_size * 2  # Double the simulation size to allow for padding
        lattice_spacing = 2
        ...
        pbp = cp.load('/home/beams0/PTYCHOSAXS/NN/probe_pinhole_bw0.75_wl1.24e-10_ps0.15_gs1024x1024.npy')
